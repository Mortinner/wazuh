...
install_remote_agent(){
        sshpass -p "$password" ssh -o StrictHostKeyChecking=accept-new "$user@$ip" curl -sO https://github.com/Mortinner/wazuh/raw/main/deploy_agent.sh && sudo bash ./deploy_agent.sh $ip_server
}
